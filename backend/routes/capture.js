...
export function captureRoutes(handlers = {}) {
  ...
  const saveBrowserSessionState = requiredHandler(handlers, 'saveBrowserSessionState')
  const listBrowserSessionStates = requiredHandler(handlers, 'listBrowserSessionStates')
  ...
  return {
    ...
    'POST /api/browser-sessions/save-state': async (payload = {}) => saveBrowserSessionState(payload),
    'GET /api/browser-sessions/states': async (payload = {}) => listBrowserSessionStates(payload),
