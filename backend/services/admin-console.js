...
<body>
  <div class="admin-layout">
    <aside class="admin-aside">
      ...
      <nav class="admin-menu" id="adminMenu">
        <button class="active" type="button" data-view="dashboard">控制台</button>
        <button type="button" data-view="projects">项目管理</button>
        <button type="button" data-view="materials">资料管理</button>
        <button type="button" data-view="generatedKnowledge">沉淀知识</button>
        <button type="button" data-view="parseJobs">解析任务</button>
        <button type="button" data-view="assets">资产管理</button>
        <button type="button" data-view="restoredPages">工程页面</button>
        <button type="button" data-view="workflowRuns">工作流运行</button>
        <button type="button" data-view="skills">技能管理</button>
  ...
  <script>
    ...
    const modules = {
      ...
      materials: {
        title: '资料管理',
        desc: '管理知识库、需求文档、竞品资料和蓝图资料。',
        collection: 'materials',
        searchable: ['title', 'type', 'status', 'content'],
        fields: [
          ['title', '资料标题', 'input'],
          ['projectId', '项目 ID', 'input'],
          ['type', '资料类型', 'select', ['knowledge', 'requirements', 'competitors', 'blueprint']],
          ['status', '状态', 'input'],
          ['meta', '来源/版本', 'input'],
          ['notes', '备注', 'textarea'],
          ['content', '内容', 'textarea']
      ...
      skills: {
        title: '技能管理',
        desc: '管理系统 Skill、自定义 Skill、审核状态和项目可见范围。',
        collection: 'skills',
    ...
    let workspace = { projects: [], materials: [], parseJobs: [], assets: [], restoredPages: [], workflowRuns: [], skillRuns: [], skills: [], settings: [] };
