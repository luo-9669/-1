...
function compactTotalDesignFlowSchemaInstruction() {
  return [
    ...
    '- 如果当前 skillId 或 requestedSkillId 是 advanced-ux-requirement-analysis，则需求分析第一阶段改用高级 UX 7 节点：ux-original-requirement-analysis、ux-design-problem-definition、ux-user-scenario、ux-interaction-chain、ux-three-design-solutions、ux-exception-flow、ux-recommendation-decision',
    '- 高级 UX 7 节点必须体现：原始需求分析、设计问题定义、用户与场景、整体交互链路、三套设计方案、异常流补充、推荐方案建议；每个判断标注 confidence，并区分 facts/inferences/suggestions/risks',
